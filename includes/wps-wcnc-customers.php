		...
		?>
			<div class="wps-wcnc-actions">
				...
				<form name="wps-wcnc-cust-all-cc" id="wps-wcnc-cust-all-cc" method="POST">
					<input type="hidden" name="action" value="wps_wcnc_camp_all" />
					<input type="hidden" name="wps_wcnc_all_camp_name" value="constantcontact" />
					<input disabled="disabled" id="wps-wcnc-cust-all-cc-btn" class="button button-primary" name="submit" value="ConstantContact" type="submit">
				</form>
							...
							<tr id="user-<?php echo $count; ?>">
								...
								<td id="wps_wcnc_actions">
									...
									<a href="#" onclick="document.getElementById('wps-wcnc-cust-<?php echo $count; ?>').submit();">
										<img src="<?php echo WPS_WOO_CUST_NEWS_CAMP_IMG_MC_CC_FR; ?>/export.png" width="10%" title="Import To Newsletter Campaigns" />
									</a>
								</td>
							</tr>
